...
const CORE_TOOLS: ToolDefinition[] = [
  ...
  },
  {
    ...
    modelDescription: 'Replace occurrences of a string in a file. Use for code edits. Pattern must match exactly once.',
    category: 'code_intelligence',
    riskLevel: 'medium',
  ...
  },
  {
    ...
    modelDescription: 'Insert content at a specific line number in a file. Line 0 inserts at the beginning. Use for adding imports, new functions, or blocks of code at a precise location.',
    category: 'code_intelligence',
    riskLevel: 'medium',
    schema: { type: 'object', properties: { file: { type: 'string', description: 'File path' }, line: { type: 'number', description: 'Line number to insert at (0-based)' }, content: { type: 'string', description: 'Content to insert' } }, required: ['file', 'line', 'content'] },
    composable: true,
    source: 'builtin',
  },
  {
    ...
    description: 'List all exported definitions (functions, classes, types) in a file',
    modelDescription: 'Scan a source file and list all top-level definitions with line numbers. Supports TS, JS, Python, Rust, Go. Use to understand file structure before editing.',
    category: 'code_intelligence',
    riskLevel: 'low',
    schema: { type: 'object', properties: { file: { type: 'string', description: 'File path to scan' } }, required: ['file'] },
    composable: true,
    source: 'builtin',
  },
  {
    id: 'code_symbols',
    name: 'List Symbols',
    description: 'List all symbols (classes, functions, interfaces, types, enums) in a file',
    modelDescription: 'List all code symbols in a file with their kind and line number. Use to get an overview of a file without reading the full content.',
    category: 'code_intelligence',
    riskLevel: 'low',
    schema: { type: 'object', properties: { file: { type: 'string', description: 'File path to scan' } }, required: ['file'] },
    composable: true,
  ...
  },
  {
    ...
    modelDescription: 'Show recent git commits. Returns commit hashes, authors, and messages. Use to understand recent changes.',
    category: 'git_vcs',
    riskLevel: 'low',
    schema: { type: 'object', properties: { count: { type: 'number', description: 'Number of commits to show (default: 10)' }, oneline: { type: 'boolean', description: 'One-line format (default: true)' } }, required: [] },
    composable: true,
    source: 'builtin',
  },
  {
    ...
    modelDescription: 'Move or rename a file or directory from one path to another.',
    category: 'filesystem',
    riskLevel: 'medium',
    schema: { type: 'object', properties: { from: { type: 'string', description: 'Source path' }, to: { type: 'string', description: 'Destination path' } }, required: ['from', 'to'] },
    composable: true,
    source: 'builtin',
  },
  {
