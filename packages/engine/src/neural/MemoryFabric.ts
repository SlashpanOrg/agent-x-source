...
export class MemoryFabric {
  ...
  async vectorSearch(embedding: number[], options: { limit?: number; category?: MemoryNodeCategory; agentId?: string; tag?: string; sessionId?: string | null; sourceId?: string | string[] } = {}): Promise<MemoryNode[]> {
    return vectorSearchImpl(this.searchCtx(), embedding, options);
  }

  async lexicalSearch(
    query: string,
    options: { limit?: number; category?: MemoryNodeCategory; agentId?: string; tag?: string; sessionId?: string | null; sourceId?: string | string[] } = {},
  ): Promise<MemoryNode[]> {
  ...
  async hybridSearch(
    embedding: number[],
    query: string,
    options: { limit?: number; category?: MemoryNodeCategory; agentId?: string; tag?: string; sessionId?: string | null; sourceId?: string | string[]; vectorLimit?: number; lexicalLimit?: number } = {},
  ): Promise<MemoryNode[]> {
